...
namespace ConsoleApp
{
    class Program
    {
        ...
        {
            string ConString = "" + @"Data source=.\SQLEXPRESS; " + "Initial catalog=AlifAcademy; " + "Trusted_Connection = True;";
            try
            {
                var enter = new Bank();
                ...
                while (true)
                {
                    ...
                    switch (choice)
                    {
                        case 1:
                            for (int i = 1; i != 0; i++)
                            {
                                Console.WriteLine("                      Вход в системуу\n");
                                Console.Write("      Логин: ");
    ...
    class Bank
    {
        ...
        public void AdminEnter(string ConString)
        {
            try
            {
                for (int i = 1; i != 0; i++)
                {
                    Console.WriteLine("                      Вход в системууу\n");
                    Console.Write("      Логин: ");
